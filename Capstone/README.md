...
2. Identify the data model.
  ...
  <tr>
    ...
    With this data model, the key information from the immigration table can be analyzed and combined with city demographics
    and airport data to gain insight effectively and efficiently.
