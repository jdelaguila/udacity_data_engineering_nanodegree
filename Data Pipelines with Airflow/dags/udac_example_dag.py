...
run_quality_checks = DataQualityOperator(
    ...
    redshift_conn_id='redshift',
    checks=[
        {'test_sql': 'SELECT COUNT(*) FROM songplays', 'expected_results': 0, 'operation':'>'},
        {'test_sql': 'SELECT COUNT(*) FROM songplays WHERE songid IS NULL', 'expected_results': 0, 'operation':'='}
    ]
)
